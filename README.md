...
`aareg`, `anova`, `aov`, `aovlist`, `Arima`, `bayesx`, `bayesGARCH`,
`BBmm`, `BBreg`, `bcplm`, `bglmerMod`, `bife`, `bigglm`, `biglm`,
`blavaan`, `bmlm`, `blmerMod`, `bracl`, `brglm2`, `brmsfit`,
`brmultinom`, `btergm`, `cch`, `cgam`, `cgamm`, `cglm`, `clm`, `clm2`,
...
`lmerModLmerTest`, `lmodel2`, `lmRob`, `lmrob`, `LORgee`, `lrm`, `mcmc`,
`mcmc.list`, `MCMCglmm`, `mclogit`, `mmclogit`, `mediate`, `mixor`,
`mjoint`, `mle2`, `mlm`, `multinom`, `negbin`, `nlmerMod`, `nlrq`,
`nlreg`, `nls`, `orcutt`, `plm`, `polr`, `ridgelm`, `rjags`, `rlm`,
