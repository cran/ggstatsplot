...
audiences. Also, note that the coefficient for `"Drama"` is statistically
significant (`*p* = 0.04`), but the confidence interval contains `0`. This is
because we set the confidence interval to `0.99`.
...
**clm and clmm examples are too time-consuming; thus not evaluated in vignette**
...
```{r clm, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 6, eval = FALSE}
# for reproducibility
set.seed(123)
...
```{r clmm1, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 6, eval = FALSE}
# for reproducibility
set.seed(123)
...
```{r felm, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 6}
library(lfe)
