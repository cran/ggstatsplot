...
```{r ggwithinstats3, message = FALSE, warning = FALSE, fig.height = 14, fig.width = 14}
# for reproducibility
set.seed(123)
library(ggstatsplot)
...
Robust | 2 |  $\delta_{R}$ (robust standardized difference similar to Cohen's *d*) | <font color="green">Yes<font>
Bayes Factor | 2 | <font color="green">Yes</font> | <font color="green">Yes</font>
