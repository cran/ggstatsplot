...
regression models saved in a tidy data frame (produced with the `broom` package
...
`clm`, `clmm`, `coeftest`, `confusionMatrix`, `coxph`, `drc`, `emmGrid`,
`epi.2by2`, `ergm`, `felm`, `fitdistr`, `glmc`, `glmerMod`, `glmmTMB`, `gls`,
`gam`, `Gam`, `gamlss`, `garch`, `glm`, `glmmadmb`, `glmmPQL`, `glmRob`,
`glmrob`, `gmm`, `ivreg`, `lavaan`, `lm`, `lm.beta`, `lmerMod`, `lmodel2`,
`lmRob`, `lmrob`, `mcmc`, `MCMCglmm`, `mclogit`, `mmclogit`, `mediate`,
`mjoint`, `mle2`, `mlm`, `multinom`, `negbin`, `nlmerMod`, `nlrq`, `nlreg`,
`nls`, `orcutt`, `plm`, `polr`, `ridgelm`, `rjags`, `rlm`, `rlmerMod`, `rq`,
...
```{r robustbase, warning = FALSE, message = FALSE, fig.height = 10, fig.width = 6}
# setup
set.seed(123)
library(robustbase)
...
```{r mixed, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 10, eval = FALSE}
# setup
set.seed(123)
library(afex)
data(sleepstudy)
...
```{r mlogit, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 7, eval=FALSE}
...
```{r mclogit, warning = FALSE, message = FALSE, fig.height = 4, fig.width = 4, eval=FALSE}
# setup
set.seed(123)
library(mclogit)
data(Transport)
...
```{r mmclogit, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 7, eval=FALSE}
# setup
set.seed(123)
library(mclogit)
data(electors)
...
```{r tobit, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 5, eval = FALSE}
# setup
set.seed(123)
library(AER)
...
```{r stanmvreg, warning = FALSE, message = FALSE, eval=FALSE, fig.height = 5, fig.width = 5}
# setup
set.seed(123)
library(rstanarm)
