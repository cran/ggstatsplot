...
`cgam`, `cgamm`, `clm`, `clmm`, `coeftest`, `confusionMatrix`, `coxme`, `coxph`,
`cpglm`, `cpglmm`, `complmrob`, `drc`, `emmGrid`, `epi.2by2`, `ergm`, `feis`,
...
`rlm`, `rlmerMod`, `rq`, `rqss`, `slm`, `speedglm`, `speedlm`, `stanfit`,
`stanreg`, `survreg`, `svyglm`, `svyolr`, `svyglm`, `tobit`, `truncreg`, `vgam`,
`wbgee`, `wblm`, etc.
...
```{r bcplm, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 10, eval=FALSE}
# set up
set.seed(123)
library(cplm)
...
```{r zcpglm, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 10, eval=FALSE}
# set up
set.seed(123)
library(cplm)
