 ...
 * A vector of values such as `notch = c(TRUE, FALSE, TRUE)` in which case it
   ...
   `notch = c(TRUE, FALSE)` will fail if we're trying to make three plots.
...
# let's split the dataframe and create a list by years of interest
cue_list <- ANT %>% split(x = ., f = .$cue, drop = TRUE)
