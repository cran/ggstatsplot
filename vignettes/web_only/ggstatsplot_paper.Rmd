...
`ggbetweenstats` | Non-parametric | Mann-Whitney *U*-test | $$r_{Spearman}$$ | <font color="green">$\checkmark$</font> 
...
`gghistostats`/`ggdotplotstats` | Parametric | One-sample *t*-test | Cohen's *d* | <font color="green">$\checkmark$</font>
`gghistostats` | Non-parametric | One-sample Wilcoxon signed rank test | $$\Delta_{LHS}$$ | <font color="green">$\checkmark$</font> 
